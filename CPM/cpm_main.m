function [y_predict, pmask,mdl, performance] = cpm_main(x,y,varargin)
...
%                    Allowed dimensions are 2D (m x nsubs) OR 3D (mx m x nsubs)
...
[y_predict,pmask,mdl]=cpm_cv(x,y,pthresh,kfolds);
